...
// Extract all the needed constructors and classes to avoid TypeScript errors
const { 
  Server,
  Networks,
  TransactionBuilder,
...
const initServer = () => {
  try {
    ...
    throw new Error('Failed to initialize Stellar connection');
  }
};
...
export const STELLAR_CONTRACT_ADDRESS = import.meta.env.VITE_STELLAR_CONTRACT_ADDRESS || "GCAPTVHUUKZN7IVVWJWNSOWUYOBPPYYAIUOOE33NHUCLCHGKGKEBUWTO";
